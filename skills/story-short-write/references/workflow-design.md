...
### 基本信息
- 标题（暂定）：{}
- 目标字数：{} 字（未指定时默认 8000-20000，见 length-routing.md）
...
- 关键角色：{一句话人设}
- 关系：{他们之间的关系}
- 为什么只有这个人会这样选：{用本篇欲望、规则和关系推导；推不出则方案作废}
...
换皮测试未通过、或说不清为什么只有这个人会这样选时，不得开始小节大纲或正文。题材风格包只提供腔调和招式，不能代替故事核。删去职业、城市和题材标签后只剩打脸、追妻、身份翻转或当众改口，视为未通过：丢掉方案，或追问会改变作品的缺口，或并列两三个方向并标出模板风险。
